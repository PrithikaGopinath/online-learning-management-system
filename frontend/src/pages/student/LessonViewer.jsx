    ...
    modules: [
      {
        ...
        lessons: [
          ...
          },
          {
            ...
            is_completed: true,
            content:
              "Welcome! Be sure to download the attached PDF for all course slides and source code links.",
            pdf_url: "#",
          },
        ],
      },
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <header className="bg-gray-900 text-white h-16 flex items-center px-4 sm:px-6 justify-between shrink-0 sticky top-0 z-20 shadow-md">
        <div className="flex items-center min-w-0">
          ...
          <Link
            to="/student"
            className="flex items-center text-gray-400 hover:text-white transition-colors mr-4 group hidden sm:flex"
          >
          ...
          <h1 className="text-sm font-semibold truncate mr-4">
            {courseData.title}
          </h1>
        </div>
        ...
        <div className="flex-1 p-4 sm:p-6 lg:p-8 flex flex-col">
          <div className="max-w-4xl mx-auto w-full">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              ...
              >
                <CheckCircle
                  className={`h-5 w-5 mr-2 ${activeLesson.is_completed ? "text-green-500" : "text-indigo-200"}`}
                />
