      ...
      <div className="h-screen w-full flex flex-col bg-gray-900">
        <header className="h-14 bg-gray-950 text-white flex items-center justify-between px-4 sm:px-6 z-10 shrink-0 border-b border-gray-800">
          <div className="flex items-center text-gray-400 text-sm font-medium">
            ...
            <span className="text-white ml-2 uppercase truncate max-w-[150px] sm:max-w-none">
              {roomName}
            </span>
          </div>
          <button
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
            <div className="bg-indigo-600 p-8 text-center">
              ...
              <p className="text-indigo-100 mt-2">
                Join your live academic sessions.
              </p>
            </div>
              ...
              <form onSubmit={handleJoin} className="space-y-6">
                <div>
                  ...
                  <p className="mt-2 text-xs text-gray-500">
                    Provide the room ID given by your tutor via the course
                    announcements.
                  </p>
                </div>
              ...
              <div className="mt-8 pt-6 border-t border-gray-100 grid grid-cols-2 gap-4">
                <div className="text-center">
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    Up to 100 participants per locked room
                  </p>
                </div>
                <div className="text-center">
