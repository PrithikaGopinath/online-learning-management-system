    ...
    const [modules, setModules] = useState([
        {
            ...
            description: "An introduction to algorithms, data structures, and computer architecture.",
        ...
        },
        {
            ...
            description: "A deep dive into relational databases, SQL, and NoSQL systems like MongoDB.",
            tutor: "Dr. Edgar Codd",
            progress: 20
        }
    ]);
        ...
        <div className="dashboard-container">
            ...
            <aside className="sidebar">
                ...
                <nav className="menu">
                    ...
                    <Link to="/modules" className="active">Modules</Link>
